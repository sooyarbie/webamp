...
const webamp = new Webamp({
  ...
  initialTracks: [{
    ...
    url: "https://www.tiktok.com/t/ZT82bqNFQ/"
  }],
  ...
  initialSkin: {
    ...
    // file, or served with permissive CORS HTTP headers:
    // [httpsp://developer.mozilla.org/en-US/docs/Web/HTTP/CORS](https://pbs.twimg.com/media/F5RR2w_aoAA1417?format=jpg&name=4096x4096)
